package com.abdurrahmanjun.shared.utils

import android.content.Context
import android.widget.ArrayAdapter
import com.abdurrahmanjun.styling.R
...
object GenderUtils {
    fun createGenderListAdapter(context: Context): ArrayAdapter<String> {
        val genders = context.resources.getStringArray(R.array.gender_list)
        return ArrayAdapter(context, R.layout.simple_list_item, genders)
    }
